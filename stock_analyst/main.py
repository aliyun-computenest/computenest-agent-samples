# -*- coding: utf-8 -*-
"""Stock Analyst Agent Service 入口。

启动时初始化 Credential 与 Agent「Stock Analyst」；Workspace 预置百炼 WebSearch MCP。
"""
...
from tools.prompts import STOCK_DEEP_RESEARCH_PROMPT
...
SYSTEM_PROMPT = STOCK_DEEP_RESEARCH_PROMPT
...
def build_app():
    """构建 Stock Analyst Agent Service。"""
